...
android {
    namespace = "com.institute.transport"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.institute.transport"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
    ...
    // Compatibility for different Android versions
    packaging {
        resources {
